  ...
  return (
    <div className="max-w-4xl mx-auto px-4 py-8">
      ...
      <div className="mb-6 flex items-center justify-between">
        <Link to={`/dashboard/events/${id}/edit`} className="text-blue-600 hover:text-blue-800 text-sm font-medium flex items-center gap-1">
      ...
      <h1 className="text-2xl font-bold text-gray-900 mb-1">Event Analytics</h1>
      {event && (
        ...
        <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-5">
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-2xl font-bold text-gray-900">{stats.total_tickets_sold}</p>
              {totalTickets > 0 && (
                <p className="text-xs text-gray-400">of {totalTickets} total</p>
              )}
            </div>
          </div>
        </div>
        ...
        <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-5">
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-2xl font-bold text-gray-900">{formatCents(stats.total_revenue_cents)}</p>
            </div>
          </div>
        </div>
        ...
        <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-5">
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-xs text-gray-400">{stats.tickets_checked_in} checked in</p>
            </div>
          </div>
        </div>
      </div>
      ...
      <div className="bg-white rounded-lg shadow-sm border border-gray-200">
        ...
        {!showAttendees && !attendeesLoading && (
          <div className="px-5 py-6 text-center">
            <p className="text-sm text-gray-500">Click &quot;View All&quot; to see the full attendee list with check-in status.</p>
          </div>
        )}
      </div>
    </div>
