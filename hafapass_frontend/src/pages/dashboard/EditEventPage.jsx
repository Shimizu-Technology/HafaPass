  ...
  if (error) {
    return (
      <div className="max-w-2xl mx-auto px-4 py-8">
        ...
        <Link to="/dashboard" className="mt-4 inline-block text-blue-600 hover:text-blue-800 text-sm font-medium">
          Back to Dashboard
        </Link>
      </div>
    )
  ...
  return (
    <div className="max-w-2xl mx-auto px-4 py-8">
      <div className="mb-6 flex items-center justify-between">
        <Link to="/dashboard" className="text-blue-600 hover:text-blue-800 text-sm font-medium flex items-center gap-1">
      ...
      {event?.status === 'draft' && (
        <div className="mb-6 p-4 bg-blue-50 border border-blue-200 rounded-lg">
          <div className="flex items-center justify-between">
            <div>
              <p className="text-sm font-medium text-blue-900">Ready to go live?</p>
              <p className="text-xs text-blue-700 mt-0.5">Publishing will make this event visible to the public.</p>
            </div>
            <button
      ...
      <form onSubmit={handleSubmit} className="space-y-8">
        {/* Basic Info Section */}
        <section>
          <h2 className="text-lg font-semibold text-gray-900 mb-4 pb-2 border-b border-gray-200">Basic Info</h2>
          <div className="space-y-4">
            <div>
              ...
              <input
                ...
                className={`w-full px-3 py-2 border rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500 ${formErrors.title ? 'border-red-300' : 'border-gray-300'}`}
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
              ...
              <div>
                <label htmlFor="age_restriction" className="block text-sm font-medium text-gray-700 mb-1">
                  Age Restriction
                </label>
                <select
                  id="age_restriction"
        ...
        {/* Venue Section */}
        <section>
          <h2 className="text-lg font-semibold text-gray-900 mb-4 pb-2 border-b border-gray-200">Venue</h2>
          <div className="space-y-4">
            <div>
              ...
              <input
                ...
                className={`w-full px-3 py-2 border rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500 ${formErrors.venue_name ? 'border-red-300' : 'border-gray-300'}`}
        ...
        {/* Date/Time Section */}
        <section>
          <h2 className="text-lg font-semibold text-gray-900 mb-4 pb-2 border-b border-gray-200">Date & Time</h2>
          <div className="space-y-4">
            <div>
              ...
              <input
                ...
                className={`w-full px-3 py-2 border rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500 ${formErrors.starts_at ? 'border-red-300' : 'border-gray-300'}`}
                disabled={submitting}
              />
            ...
            <div>
              <label htmlFor="doors_open_at" className="block text-sm font-medium text-gray-700 mb-1">
                Doors Open At
              </label>
              <input
                id="doors_open_at"
        ...
        {/* Settings Section */}
        <section>
          <h2 className="text-lg font-semibold text-gray-900 mb-4 pb-2 border-b border-gray-200">Settings</h2>
          <div className="space-y-4">
            <div>
            ...
            <div>
              ...
              <input
                ...
                disabled={submitting}
              />
              <p className="mt-1 text-xs text-gray-500">Paste a URL for your event cover image</p>
            </div>
          </div>
        </section>
        ...
        <div className="pt-4 border-t border-gray-200">
          <button
            type="submit"
            disabled={submitting}
            className="w-full sm:w-auto bg-blue-900 text-white py-2.5 px-6 rounded-md font-medium hover:bg-blue-800 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2 disabled:opacity-50 disabled:cursor-not-allowed transition-colors"
          >
