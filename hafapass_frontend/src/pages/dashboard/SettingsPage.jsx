  ...
  return (
    <div className="max-w-3xl mx-auto px-4 sm:px-6 py-8">
      ...
      <div className="bg-white border border-gray-200 rounded-xl shadow-sm p-6 mb-6">
        <h2 className="text-lg font-semibold text-gray-900 mb-1">Payment Mode</h2>
            ...
            return (
              ...
              >
                <div className="flex items-center gap-3">
                  <div className={`w-3 h-3 rounded-full ${isActive ? mode.dot : 'bg-gray-300'}`} />
                  <div>
      ...
      {settings && (
        <div className="bg-white border border-gray-200 rounded-xl shadow-sm p-6">
          ...
          <div className="grid grid-cols-2 gap-4 text-sm">
            <div>
              <p className="text-gray-500">Platform Name</p>
              <p className="text-gray-900 font-medium">{settings.platform_name}</p>
            </div>
            <div>
              <p className="text-gray-500">Contact Email</p>
              <p className="text-gray-900 font-medium">{settings.platform_email || '\u2014'}</p>
            </div>
            <div>
              <p className="text-gray-500">Service Fee</p>
              <p className="text-gray-900 font-medium">{settings.service_fee_percent}% + ${(settings.service_fee_flat_cents / 100).toFixed(2)}/ticket</p>
            </div>
            <div>
              <p className="text-gray-500">Stripe Keys</p>
